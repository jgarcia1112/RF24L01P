 ...
 *
 *  Modificado: 03 Jul 2017 por jgarcia1112@gmail.com
 *
...
void nRF24L01P::powerUp() {
    ...
    //RQST_TO_DEVICE(W_REGISTER | CONFIG, POWER_UP_DEVICE);
...
void nRF24L01P::powerDown() {
    ...
    //RQST_TO_DEVICE(W_REGISTER | CONFIG, POWER_DOWN_DEVICE);
