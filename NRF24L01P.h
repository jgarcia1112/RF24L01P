...
#define DEFAULT_ADDR_WIDTH      5               /* 5 bytes (40 bits) de ancho */
#define MAX_LEN_FIFO_SIZE       32              /* Maximo 32 bytes (256 bits) */

/*
static uint8_t logic_channel_addrs[6][DEFAULT_ADDR_WIDTH] = {
    { 0xE1, 0xE2, 0xE7, 0xE7, 0xE7 },
...
private:
    ...
    void
        ...
        spiWrite(uint8_t cmd, const int8_t* pBuffer, uint8_t lenBuffer = 1);
