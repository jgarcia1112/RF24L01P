...
static  uint8_t LOGIC_CHANNEL_ADDR1[] = { 0xE7, 0xE7 ,0xE7 ,0xE7 ,0xE7 };
static  uint8_t LOGIC_CHANNEL_ADDR2[] = { 0xC2, 0xC2 ,0xC2 ,0xC2 ,0xC2 };
static  uint8_t LOGIC_CHANNEL_ADDR3[] = { 0xC2, 0xC2 ,0xC2 ,0xC2 ,0xC3 };
static  uint8_t LOGIC_CHANNEL_ADDR4[] = { 0xC2, 0xC2 ,0xC2 ,0xC2 ,0xC4 };
static  uint8_t LOGIC_CHANNEL_ADDR5[] = { 0xC2, 0xC2 ,0xC2 ,0xC2 ,0xC5 };
static  uint8_t LOGIC_CHANNEL_ADDR6[] = { 0xC2, 0xC2 ,0xC2 ,0xC2 ,0xC6 };
...
#define CHANNEL4                0x06
#define CHANNEL5                0x08
#define CHANNEL6                0x0A
#define CHANNEL_MASK            0x0E
...
#define GET_SENDER_PORT()       ( GET_DEVICE_STATUS() & CHANNEL_MASK )
...
public:
    ...
    void
        ...
        setRadioLayer(uint8_t radioFrequency, uint8_t outputPower, uint8_t radiosDataRate, uint8_t crcMode),
        ...
        startTx(uint8_t logicChannel = LOGIC_CHANNEL_PORT1),
